...
class projectcount extends base {
    ...
    public function setup_form(MoodleQuickForm $mform): void {
        $mform->addElement(
            ...
            [
                '' => get_string('any'),
                'none' => get_string('filter_projects_none', 'mod_projetvet'),
                'has' => get_string('filter_projects_has', 'mod_projetvet'),
            ]
        );
    }
